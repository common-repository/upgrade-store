 ...
 */
class Upgrade_Store_Post_Types
{
    ...
    private function register_single_post_type($fields)
    {
        ...
        $labels = array(
            ...
            'new_item'              => sprintf(esc_html__('New %s', 'upgrade-store'), $fields['singular']),
            'add_new'               => esc_html__('Add New', 'upgrade-store'),
            'add_new_item'          => sprintf(esc_html__('Add New %s', 'upgrade-store'), $fields['singular']),
            'edit_item'             => sprintf(esc_html__('Edit %s', 'upgrade-store'), $fields['singular']),
            'view_item'             => sprintf(esc_html__('View %s', 'upgrade-store'), $fields['singular']),
            'view_items'            => sprintf(esc_html__('View %s', 'upgrade-store'), $fields['plural']),
            'search_items'          => sprintf(esc_html__('Search %s', 'upgrade-store'), $fields['plural']),
            'not_found'             => sprintf(esc_html__('No %s found', 'upgrade-store'), strtolower($fields['plural'])),
            'not_found_in_trash'    => sprintf(esc_html__('No %s found in trash', 'upgrade-store'), strtolower($fields['plural'])),
            'all_items'             => sprintf(esc_html__('%s', 'upgrade-store'), $fields['all_items']),
            'archives'              => sprintf(esc_html__('%s Archives', 'upgrade-store'), $fields['singular']),
            'attributes'            => sprintf(esc_html__('%s Attributes', 'upgrade-store'), $fields['singular']),
            'insert_into_item'      => sprintf(esc_html__('Insert into %s', 'upgrade-store'), strtolower($fields['singular'])),
            'uploaded_to_this_item' => sprintf(esc_html__('Uploaded to this %s', 'upgrade-store'), strtolower($fields['singular'])),

            /* Labels for hierarchical post types only. */
            'parent_item'           => sprintf(esc_html__('Parent %s', 'upgrade-store'), $fields['singular']),
            'parent_item_colon'     => sprintf(esc_html__('Parent %s:', 'upgrade-store'), $fields['singular']),
    ...
    private function register_single_post_type_taxnonomy($tax_fields)
    {
        ...
        $labels = array(
            ...
            'all_items'                  => sprintf(esc_html__('All %s', 'upgrade-store'), $tax_fields['plural']),
            'edit_item'                  => sprintf(esc_html__('Edit %s', 'upgrade-store'), $tax_fields['single']),
            'view_item'                  => sprintf(esc_html__('View %s', 'upgrade-store'), $tax_fields['single']),
            'update_item'                => sprintf(esc_html__('Update %s', 'upgrade-store'), $tax_fields['single']),
            'add_new_item'               => sprintf(esc_html__('Add New %s', 'upgrade-store'), $tax_fields['single']),
            'new_item_name'              => sprintf(esc_html__('New %s Name', 'upgrade-store'), $tax_fields['single']),
            'parent_item'                => sprintf(esc_html__('Parent %s', 'upgrade-store'), $tax_fields['single']),
            'parent_item_colon'          => sprintf(esc_html__('Parent %s:', 'upgrade-store'), $tax_fields['single']),
            'search_items'               => sprintf(esc_html__('Search %s', 'upgrade-store'), $tax_fields['plural']),
            'popular_items'              => sprintf(esc_html__('Popular %s', 'upgrade-store'), $tax_fields['plural']),
            'separate_items_with_commas' => sprintf(esc_html__('Separate %s with commas', 'upgrade-store'), $tax_fields['plural']),
            'add_or_remove_items'        => sprintf(esc_html__('Add or remove %s', 'upgrade-store'), $tax_fields['plural']),
            'choose_from_most_used'      => sprintf(esc_html__('Choose from the most used %s', 'upgrade-store'), $tax_fields['plural']),
            'not_found'                  => sprintf(esc_html__('No %s found', 'upgrade-store'), $tax_fields['plural']),
        );
        ...
        $args = array(
            ...
            'meta_box_cb'           => (isset($tax_fields['meta_box_cb']))           ? $tax_fields['meta_box_cb']           : true,
        ...
        $post_types_fields = array(
            ...
            array(
                ...
                'rewrite' => array(
                    ...
                    'slug'       => 'product-tab', // string (defaults to the post type name)
